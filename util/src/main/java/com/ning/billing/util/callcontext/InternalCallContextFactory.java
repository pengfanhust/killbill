...
public class InternalCallContextFactory {
    ...
    private final EntityDao<Account> accountDao;

    @Inject
    public InternalCallContextFactory(final EntityDao<Account> accountDao) {
    ...
    public InternalTenantContext createInternalTenantContext(final UUID accountId) {
        ...
        final Long accountRecordId = accountDao.getRecordId(accountId);
