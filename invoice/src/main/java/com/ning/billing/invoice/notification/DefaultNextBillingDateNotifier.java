        ...
        final NotificationQueueHandler notificationQueueHandler = new NotificationQueueHandler() {
            ...
            public void handleReadyNotification(final NotificationKey notificationKey, final DateTime eventDate) {
                try {
                    ...
                    try {
                        final Subscription subscription = entitlementUserApi.getSubscriptionFromId(key.getUuidKey(), internalCallContextFactory.createInternalTenantContext().toTenantContext());
