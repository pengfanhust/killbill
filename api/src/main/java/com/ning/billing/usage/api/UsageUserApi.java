...
public interface UsageUserApi {
     ...
     */
    public void incrementUsage(UUID bundleId, String metricName, CallContext context);
     ...
     */
    public void recordUsage(UUID bundleId, String metricName, DateTime timestamp, long value, CallContext context);
     ...
     * @param context    tenant context
     */
    public void recordRolledUpUsage(UUID bundleId, String metricName, DateTime startDate, DateTime endDate, long value, CallContext context);
}
